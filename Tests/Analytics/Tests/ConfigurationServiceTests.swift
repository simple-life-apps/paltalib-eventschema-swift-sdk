...
final class ConfigurationServiceTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        userDefaults.set(nil, forKey: "pb-paltaBrainRemoteConfig")
    }
    ...
    func testRequestConfigSuccessWithoutCache() {
        ...
        XCTAssertNotNil(userDefaults.object(for: "pb-paltaBrainRemoteConfig") as RemoteConfig?)
    }
    ...
    func testRequestConfigSuccessWithCache() {
        ...
        XCTAssertEqual(userDefaults.object(for: "pb-paltaBrainRemoteConfig"), remoteConfig)
    }
