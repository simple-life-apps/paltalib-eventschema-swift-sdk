...
final class SessionManagerTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        userDefaults.set(nil, forKey: "pb-paltaBrainSession")
    ...
    func testRestoreSession() {
        ...
        userDefaults.set(try! JSONEncoder().encode(session), forKey: "pb-paltaBrainSession")
    ...
    func testRefreshSessionValid() throws {
        ...
        let session = try userDefaults
            .data(forKey: "pb-paltaBrainSession")
